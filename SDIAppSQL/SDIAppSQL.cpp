...
// SDIAppSQL.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CSDIAppSQLApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CSDIAppSQLApp::OnAppAbout)
...
// Создание CSDIAppSQLApp

CSDIAppSQLApp::CSDIAppSQLApp() noexcept
{
	...
	SetAppID(_T("SDIAppSQL.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CSDIAppSQLApp

CSDIAppSQLApp theApp;


// Инициализация CSDIAppSQLApp

BOOL CSDIAppSQLApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CSDIAppSQLDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CSDIAppSQLView));
	if (!pDocTemplate)
		return FALSE;
...
int CSDIAppSQLApp::ExitInstance()
{
...
// Обработчики сообщений CSDIAppSQLApp
